...
spin_list = [443.72, 45.32, 22.59, 6.68, 20.86, 9.13, 65.18, 86.51, 38.3, 6.84, 37.31, 12.45, 43.16, 67.98, 6.08]
...
cbar = plt.colorbar(im1, orientation="horizontal", cax=cax1, ticks=np.arange(0., 525., 75.), extend='max', extendrect=True, label=r"$T_{c} (K)$", alpha=1)
cbar.set_alpha(1)
cbar.draw_all()
...
plt.savefig("GASS_cloud_spintemp.pdf")
#plt.show()
