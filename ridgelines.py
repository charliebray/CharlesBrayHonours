...
# Find index where optical depth maximal (151). Then take a velocity min and max about this index.
# Then find velocity inidices for T_B that are near this min/max. Then take T_B values

#vrad_min = abs_vrad[151-2]
#vrad_max = abs_vrad[151+2]
...
#min_index = find_nearest(em_vrad, vrad_min)
#max_index = find_nearest(em_vrad, vrad_max)

#ye_EW = abs_EW[151-2: 151+2]
#ye_T_B = em_T_B[min_index: max_index]
